...
var FICT_DATA = {
  ...
  reunioes: {
    Luana:     [ 4,  5,  6,  5,  7,  6,  8,  7,  9,  8, 10,  9],
    Thamiris:  [ 6,  7,  8,  7,  9, 10, 11,  9, 12, 13, 14, 12],
    Gabriella: [ 3,  4,  5,  4,  6,  5,  7,  6,  8,  7,  9,  8]
  },
  negocios: {  // fecharam negocio (upgrade, reativacao, plataforma, etc)
    Luana:     [ 1,  1,  2,  1,  2,  2,  3,  2,  3,  3,  4,  3],
    Thamiris:  [ 2,  3,  3,  2,  4,  4,  5,  4,  6,  5,  6,  5],
    Gabriella: [ 1,  1,  1,  1,  2,  1,  2,  2,  3,  2,  3,  3]
  }
};
